...
/**
 * Add `is-active` class to active menu item
 */
fabricator.setActiveItem = function () {
	...
	var parsedItems = function () {
		...
		for (var i = fabricator.dom.menuItems.length - 1; i >= 0; i--) {
			...
			fabricator.dom.menuItems[i].classList.remove('is-active');

			// get item href
			href = fabricator.dom.menuItems[i].children[0].getAttribute('href');
	...
	var setActive = function () {
		...
		fabricator.dom.menuItems[index].classList.add('is-active');
